 ...
 */
 class FlickrAlbumGallery {
	...
	public function FAG_Translate() {
		load_plugin_textdomain('weblizar_fag', FALSE, dirname( plugin_basename(__FILE__)).'/languages/' );
	}
	...
	public function fag_meta_box_form_function($post) {
		...
		<?php if(!isset($FAG_Custom_CSS)) $FAG_Custom_CSS = ""; ?>
				...
				<p class="description">
					...
					<?php _e('Note', FAG_TEXT_DOMAIN); ?><strong>:</strong> <?php _e('Please Do Not Use', FAG_TEXT_DOMAIN); ?> <strong>&lt;style&gt;...&lt;/style&gt;</strong> <?php _e('Tag With Custom CSS', FAG_TEXT_DOMAIN); ?>.
				</p>
